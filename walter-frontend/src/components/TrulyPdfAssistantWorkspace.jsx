...
const PDF_TOOLS = [
  ...
  },
  {
    id: "pdf-to-word",
    name: "PDF to Word",
    description: "Convert PDF files into editable DOC and DOCX documents in seconds.",
    category: "convert",
  ...
  },
  {
    ...
    description: "Turn PDF files into editable PPT and PPTX slideshows.",
    category: "convert",
  ...
  },
  {
    ...
    description: "Make PPT and PPTX slideshows easy to share by converting them to PDF.",
    category: "convert",
  ...
  },
  {
    id: "excel-to-pdf",
    name: "Excel to PDF",
    description: "Make spreadsheets easy to read by converting them to PDF.",
    category: "convert",
  ...
  },
  {
    id: "edit-pdf",
    name: "Edit PDF",
    description: "Add text, images, shapes, and annotations to a PDF document.",
    category: "organize",
    path: "/tool/edit-pdf",
    icon: PenTool,
  ...
  },
  {
    id: "jpg-to-pdf",
    name: "JPG to PDF",
    description: "Convert JPG images to PDF in seconds with margin and orientation controls.",
    category: "convert",
  ...
  },
  {
    id: "watermark-pdf",
    name: "Watermark",
    description: "Stamp image or text over your PDF in seconds.",
    category: "security",
  ...
  },
  {
    id: "rotate-pdf",
    name: "Rotate PDF",
    description: "Rotate PDFs exactly the way you need.",
    category: "organize",
  ...
  },
  {
    id: "html-to-pdf",
    name: "HTML to PDF",
    description: "Convert webpages in HTML to PDF by using a URL.",
    category: "convert",
  ...
  },
  {
    id: "unlock-pdf",
    name: "Unlock PDF",
    description: "Remove PDF password security and unlock files.",
    category: "security",
  ...
  },
  {
    id: "organize-pdf",
    name: "Organize PDF",
    description: "Sort, delete, and add pages inside your PDF document.",
    category: "organize",
  ...
  },
  {
    id: "page-numbers",
    name: "Page numbers",
    description: "Add page numbers into PDFs with full position controls.",
    category: "organize",
  ...
  },
  {
    id: "scan-to-pdf",
    name: "Scan to PDF",
    description: "Capture document scans from your device and send them to your browser.",
    category: "convert",
  ...
  },
  {
    id: "ocr-pdf",
    name: "OCR PDF",
    description: "Convert scanned PDF files into searchable and selectable documents.",
    category: "optimize",
    path: "/tool/ocr-pdf",
    icon: FileCheck2,
  ...
  },
  {
    id: "compare-pdf",
    name: "Compare PDF",
    description: "Show side-by-side document comparison and spot all changes.",
    category: "organize",
  ...
  },
  {
    id: "crop-pdf",
    name: "Crop PDF",
    description: "Crop PDF margins or select specific page areas.",
    category: "organize",
    path: "/tool/crop-pdf",
    icon: Scissors,
  ...
  },
  {
    id: "ai-summarizer",
    name: "AI Summarizer",
    description: "Generate concise summaries from long PDFs and reports.",
    category: "optimize",
  ...
  },
  {
    id: "translate-pdf",
    name: "Translate PDF",
    description: "Translate PDF files while preserving structure and readability.",
    category: "convert",
